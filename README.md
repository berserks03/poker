...
Your need to implement the `process` method in the [solver.js](solver.js) file.
...
All the unit tests in [texas.holdem.solver.spec.js](tests/texas.holdem.solver.spec.js), [omaha.holdem.solver.spec.js](tests/omaha.holdem.solver.spec.js), and
 [five.card.draw.solver.spec.js](tests/five.card.draw.solver.spec.js) should pass. There will also be other tests run after you submit your solver. 
...
Once you are finished with the task, please click the `Complete task` link on <a href="https://app.codescreen.dev/#/codescreentest610820948db8eb04e6ea0ddf" target="_blank">this screen</a>.